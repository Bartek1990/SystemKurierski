...
public class Employee extends Person{
              ...
              String account, String DataName, int dataCountryId, String dataDetails, int zipCode, String city, String tel, String mail)
    {
        ...
        String query1 = "INSERT INTO data VALUES " + "(0,"+DataName+","+dataCountryId+","+dataDetails+","+zipCode+","+city+","+tel+","+mail+")";
        ...
        //String query2 = "INSERT INTO employee VALUES " + "(0,"+login+","+password+","+forename+","+surename+","+dataId+","+empDate+","+earnings+","+baseid+","+workTime+","+false+","+nip+","+account+")";
        ...
        //Client.request(queryDataId);
        //Client.request(query2);
        //Client.request(queryDEmployeeId);
    }
    @Override
